    ...
    return (
        <div className='container'>
            <div className='border w-1/2 mx-auto'>
                <h1 className='text-5xl'>what is cors?</h1>
            ...
            <div className='border w-1/2 mx-auto'>
                <h1 className='text-5xl'>Why are you using firebase? What other options do you have to implement authentication?</h1>
                <p class="font-bold">Answer</p>
            ...
            <div className='border w-1/2 mx-auto'>
                <h1 className='text-5xl'>How does the private route work?</h1>
                <p className='font-bold'>Answer</p>
                <p>The private route component is similar to the public route, the only change is that redirect URL and authenticate condition. If the user is not authenticated he will be redirected to the login page and the user can only access the authenticated routes If he is authenticated (Logged in).</p>
            </div>
            <div className='border w-1/2 mx-auto'>
                <h1 className='text-5xl'>What is Node? How does Node work?</h1>
                <p className='font-bold'>Answer</p>
